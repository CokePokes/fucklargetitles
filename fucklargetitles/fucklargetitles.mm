...
CHConstructor // code block that runs immediately upon load
{
	@autoreleasepool
	{
		...
		// this would be posted using: notify_post("com.cokepokes.fucklargetitles.eventname");
		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("com.cokepokes.fucklargetitles.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
